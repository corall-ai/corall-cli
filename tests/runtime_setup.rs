...
#[cfg(unix)]
#[test]
fn runtime_setup_openclaw_installs_bundled_polling_plugin() -> Result<(), Box<dyn Error>> {
    let temp = TempDir::new("corall-runtime-openclaw-setup")?;
    ...
    assert_eq!(stdout["runtime"], "openclaw");
